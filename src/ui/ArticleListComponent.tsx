...
export const ArticleListComponent: FC<ArticleListProps> = ({
  ...
  return (
    <div className="group pointer-events-none relative flex flex-col ">
      ...
      <span className="absolute left-[-1px] top-[-1px] z-0 h-full w-0 rounded-lg bg-gradient-to-br from-primary-200 to-primary-700 transition-all duration-300 group-hover:h-[calc(100%_+_2px)] group-hover:w-[calc(100%_+_2px)]" />
